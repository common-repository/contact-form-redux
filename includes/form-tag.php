...
class CFREDUX_FormTag implements ArrayAccess
{
    ...
    public function get_default_option($default = '', $args = '')
    {
        ...
        foreach ($options as $opt) {
            ...
            if ('user_' == substr($opt, 0, 5) && is_user_logged_in()) {
                ...
                $vals = array_map('cfredux_sanitize_query_var', $vals);
                ...
                if ($contact_form = CFREDUX_ContactForm::get_current()) {
    ...
    public function get_data_option($args = '')
    {
        ...
        return apply_filters('cfredux_form_tag_data_option', null, $options, $args);
    }

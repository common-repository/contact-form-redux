...
function cfredux_is_valid_locale($locale)
{
    $pattern = '/^[a-z]{2,3}(?:_[a-zA-Z_]{2,})?$/';
    return (bool) preg_match($pattern, $locale);
}

function cfredux_is_rtl($locale = '')
{
...
function cfredux_load_textdomain($locale = null)
{
    global $l10n;

    $domain = 'contact-form-redux';

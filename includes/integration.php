...
class CFREDUX_Integration
{
    ...
    public function add_service($name, CFREDUX_Service $service)
    {
    ...
    public function list_services($args = '')
    {
        ...
        foreach ($services as $name => $service) {
            ...
            ?>
            <div 
                class="card<?php echo $service->is_active() ? ' active' : ''; ?>" 
                id="<?php echo esc_attr($name); ?>"
            >
                <?php $service->icon(); ?>
                <h2 
                    class="title"
                ><?php echo esc_html($service->get_title()); ?></h2>
                <div class="infobox">
...
abstract class CFREDUX_Service
{

...
add_filter('cfredux_special_mail_tags', 'cfredux_special_mail_tag', 10, 3);

function cfredux_special_mail_tag($output, $name, $html)
{
    $name = preg_replace('/^cfredux\./', '_', $name); // for back-compat
...
add_filter('cfredux_special_mail_tags', 'cfredux_post_related_smt', 10, 3);

function cfredux_post_related_smt($output, $name, $html)
{
...
add_filter('cfredux_special_mail_tags', 'cfredux_site_related_smt', 10, 3);

function cfredux_site_related_smt($output, $name, $html)
{
...
add_filter('cfredux_special_mail_tags', 'cfredux_user_related_smt', 10, 3);

function cfredux_user_related_smt($output, $name, $html)
{
